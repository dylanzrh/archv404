...
const ABOUT_TEXT: string =
  'ARCHIVE 404 IS A ZURICH-BASED EVENT LABEL CURATING CAREFULLY DESIGNED EXPERIENCES WHERE SOUND, LIGHT AND SPACE CREATE IMMERSIVE MOMENTS. ITS NAME REINTERPRETS A DIGITAL ERROR AS AN INVITATION TO RECONNECT THROUGH PEOPLE AND SOUND. BY BRINGING TOGETHER RESPECTED INTERNATIONAL ARTISTS AND SOME OF THE MOST PROMISING LOCAL TALENTS, ARCHIVE 404 CREATES AN ENERGY THAT FEELS CONTEMPORARY YET TIMELESS.';
